...
class ChipsViewController: UIViewController {
    ...
    fileprivate static var chips = [
        (title: "Afghanistan", selected: false, enabled: false, iconName: BPKIconName.awardLg),
        (title: "Belgium", selected: false, enabled: true, iconName: BPKIconName.accountLg),
        (title: "Canada", selected: false, enabled: true, iconName: BPKIconName.adultLg),
        (title: "Denmark", selected: false, enabled: true, iconName: BPKIconName.airlineLg),
        (title: "Ethiopia", selected: true, enabled: true, iconName: BPKIconName.arrowUpLg),
        (title: "Fiji", selected: false, enabled: true, iconName: BPKIconName.alertAddLg),
        (title: "Germany", selected: false, enabled: true, iconName: BPKIconName.accountIdCardLg),
        (title: "Honduras", selected: false, enabled: true, iconName: BPKIconName.alertActiveLg),
        (title: "India", selected: true, enabled: true, iconName: BPKIconName.baggageAddLg),
        (title: "Jamaica", selected: false, enabled: true, iconName: BPKIconName.calendarLg),
        (title: "Kosovo", selected: false, enabled: false, iconName: BPKIconName.cafeLg),
        (title: "Lesotho", selected: false, enabled: true, iconName: BPKIconName.closeLg),
        (title: "Madagascar", selected: true, enabled: true, iconName: BPKIconName.cameraLg)
    ]
